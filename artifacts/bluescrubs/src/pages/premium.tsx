...
export default function Premium() {
  ...
  return (
    <div className="container mx-auto px-4 py-8 pb-24">
      <div className="mb-8">
        <h1 className="text-3xl md:text-4xl font-semibold mb-4">Premium Features</h1>
      ...
      <Card className="bg-white border-slate-200 rounded-2xl">
        ...
        <CardContent className="text-center">
          <div className="mb-6">
            <div className="text-3xl md:text-4xl font-semibold text-teal-600 mb-2">£79/month</div>
